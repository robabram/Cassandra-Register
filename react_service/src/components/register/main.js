      ...
      <div className={'top-level-page'}>
        ...
        <Grid>
          ...
          <Column sm={4} md={{span: 6, offset: 1}} lg={{span: 10, offset: 1}}>
            <div className={'register-item'}>
              <Grid>
                <Column sm={4} md={8} lg={10}><div className={'register-item-title'}>RDR Genomics Work Queue Update Release</div></Column>
                <Column sm={4} md={{span: 2}} lg={{span: 2}}>
            ...
            <div className={'register-item'}>
              <Grid>
                ...
                <Column sm={4} md={{span: 2}} lg={{span: 2}}>
                  ...
                  <div>
                    <Tag type={'blue'} size={'sm'}>Curation</Tag><Tag type={'green'} size={'sm'}>Vocabulary</Tag><Tag type={'red'} size={'sm'}>Hotfix</Tag>
                  </div>
                </Column>
                <Column sm={4} md={{span: 6}} lg={{span: 8}}>
                  <div>
